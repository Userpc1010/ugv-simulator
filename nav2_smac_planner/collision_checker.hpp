 ...
 */
class CollisionChecker: public FootprintCollisionChecker<Costmap2D *>
{
public:
  /**
   * @brief A constructor for CollisionChecker
   ...
   */
  CollisionChecker(std::shared_ptr< Costmap2D_Master> costmap,unsigned int num_quantizations);
   ...
   * @return Costmap ros
   */
  std::shared_ptr<Costmap2D_Master> getCostmapMaster() {return costmap_master_;}
...
protected:
  ...
  Footprint * oriented_footprints_ = nullptr;
  uint16_t footprint_size;
  Footprint * unoriented_footprint_ = nullptr;
  float center_cost_;
