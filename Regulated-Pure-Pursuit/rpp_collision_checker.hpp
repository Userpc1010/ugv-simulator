#ifndef RPP_COLLISION_CHECKER_HPP
#define RPP_COLLISION_CHECKER_HPP
...
/**
 * @brief Упрощённый коллизия-чекер для RPP
 *
 * Заменяет nav2_costmap_2d::Costmap2DROS и footprint_collision_checker
 * прямым доступом к данным costmap
 */
...
#endif  // RPP_COLLISION_CHECKER_HPP
