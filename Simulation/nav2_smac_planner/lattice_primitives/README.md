...
В терминале выполните команду, которая временно добавит папку проекта в пути поиска Python:

```
export PYTHONPATH=$PYTHONPATH:/home/sencis/SmacPlanner_GUI
python3 /home/sencis/SmacPlanner_GUI/nav2_smac_planner/lattice_primitives/generate_motion_primitives.py [--config] [--output] [--visualizations]
