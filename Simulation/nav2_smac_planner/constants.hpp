...
const float UNKNOWN_COST = 255.0f;
const float OCCUPIED_COST = 254.0f;
const float INSCRIBED_COST = 253.0f;
const float MAX_NON_OBSTACLE_COST = 252.0f;
const float FREE_COST = 0.0f;
